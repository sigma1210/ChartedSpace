...
import { MaydayBoard } from "./MaydayBoard";

export const MaydayModal = () => {
  ...
  return (
    ...
    >
      <div
        className="hud-panel flex h-[min(90vh,820px)] w-[min(98vw,1480px)] flex-col overflow-hidden border-white/22 shadow-[inset_0_1px_0_rgba(255,255,255,0.20),inset_0_-1px_0_rgba(255,255,255,0.06),0_24px_80px_rgba(0,0,0,0.55)] backdrop-blur-2xl"
