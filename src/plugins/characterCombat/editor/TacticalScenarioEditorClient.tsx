...
import { TacticalEditorViewportProvider } from "@/plugins/characterCombat/editor/TacticalEditorViewport";
import {
...
import { useTacticalEditorTracingTemplate } from "@/plugins/characterCombat/editor/useTacticalEditorTracingTemplate";
import { useTacticalEditorEnemies } from "@/plugins/characterCombat/editor/useTacticalEditorEnemies";
import { useTacticalEditorElevationTransitions } from "@/plugins/characterCombat/editor/useTacticalEditorElevationTransitions";
import { useTacticalEditorFire } from "@/plugins/characterCombat/editor/useTacticalEditorFire";
import { useTacticalEditorNaturalTerrain } from "@/plugins/characterCombat/editor/useTacticalEditorNaturalTerrain";
import { useTacticalEditorTerrainPlacements } from "@/plugins/characterCombat/editor/useTacticalEditorTerrainPlacements";
import { useTacticalEditorAreas } from "@/plugins/characterCombat/editor/useTacticalEditorAreas";
import { useTacticalEditorAreaDrawing } from "@/plugins/characterCombat/editor/useTacticalEditorAreaDrawing";
import { useTacticalEditorAreaCurveControls } from "@/plugins/characterCombat/editor/useTacticalEditorAreaCurveControls";
import { useTacticalEditorWallDrawing } from "@/plugins/characterCombat/editor/useTacticalEditorWallDrawing";
import { useTacticalEditorWallEditing } from "@/plugins/characterCombat/editor/useTacticalEditorWallEditing";
import { useTacticalEditorWallPortals } from "@/plugins/characterCombat/editor/useTacticalEditorWallPortals";
import { useTacticalEditorCirclePrimitives } from "@/plugins/characterCombat/editor/useTacticalEditorCirclePrimitives";
import { useTacticalEditorInteractionOperations } from "@/plugins/characterCombat/editor/useTacticalEditorInteractionOperations";
import { useTacticalEditorInteractionPlacement } from "@/plugins/characterCombat/editor/useTacticalEditorInteractionPlacement";
import { useTacticalEditorSelectionDeletion } from "@/plugins/characterCombat/editor/useTacticalEditorSelectionDeletion";
import { useTacticalEditorLayerSelection } from "@/plugins/characterCombat/editor/useTacticalEditorLayerSelection";
import { useTacticalEditorToolActivation } from "@/plugins/characterCombat/editor/useTacticalEditorToolActivation";
import { useTacticalEditorSelectionState } from "@/plugins/characterCombat/editor/useTacticalEditorSelectionState";
import { useTacticalEditorHudLayoutState } from "@/plugins/characterCombat/editor/useTacticalEditorHudLayoutState";
import { useTacticalEditorToolState } from "@/plugins/characterCombat/editor/useTacticalEditorToolState";
import { useTacticalEditorDocumentState } from "@/plugins/characterCombat/editor/useTacticalEditorDocumentState";
import { useTacticalEditorFileState } from "@/plugins/characterCombat/editor/useTacticalEditorFileState";
import { useTacticalEditorScenarioProperties } from "@/plugins/characterCombat/editor/useTacticalEditorScenarioProperties";
import { useTacticalEditorValidation } from "@/plugins/characterCombat/editor/useTacticalEditorValidation";
import { useTacticalEditorPlaytest } from "@/plugins/characterCombat/editor/useTacticalEditorPlaytest";
import { useTacticalEditorLayerPresentation } from "@/plugins/characterCombat/editor/useTacticalEditorLayerPresentation";
import { tacticalEditorHiddenHuds } from "@/plugins/characterCombat/editor/tacticalEditorHiddenHuds";
import TacticalEditorDraftPreview from "@/plugins/characterCombat/editor/TacticalEditorDraftPreview";
import TacticalEditorAreaPropertiesHud from "@/plugins/characterCombat/editor/TacticalEditorAreaPropertiesHud";
import TacticalEditorEnemyHud from "@/plugins/characterCombat/editor/TacticalEditorEnemyHud";
import TacticalEditorEnemyPaletteHud from "@/plugins/characterCombat/editor/TacticalEditorEnemyPaletteHud";
import TacticalEditorInteractionHud from "@/plugins/characterCombat/editor/TacticalEditorInteractionHud";
import TacticalEditorOpenScenarioDialog from "@/plugins/characterCombat/editor/TacticalEditorOpenScenarioDialog";
import TacticalEditorScenarioPropertiesDialog from "@/plugins/characterCombat/editor/TacticalEditorScenarioPropertiesDialog";
import TacticalEditorNewScenarioDialog from "@/plugins/characterCombat/editor/TacticalEditorNewScenarioDialog";
import TacticalEditorSaveAsDialog from "@/plugins/characterCombat/editor/TacticalEditorSaveAsDialog";
import TacticalEditorFileMenu from "@/plugins/characterCombat/editor/TacticalEditorFileMenu";
import TacticalEditorScenarioMenu from "@/plugins/characterCombat/editor/TacticalEditorScenarioMenu";
import TacticalEditorHeader from "@/plugins/characterCombat/editor/TacticalEditorHeader";
import TacticalEditorLayersHud from "@/plugins/characterCombat/editor/TacticalEditorLayersHud";
import TacticalEditorDrawingPrecisionControl from "@/plugins/characterCombat/editor/TacticalEditorDrawingPrecisionControl";
import { useTacticalEditorDraftCommands } from "@/plugins/characterCombat/editor/useTacticalEditorDraftCommands";
import { useTacticalEditorTerrainPlacementRouter } from "@/plugins/characterCombat/editor/useTacticalEditorTerrainPlacementRouter";
import { useTacticalEditorPreviewSelection } from "@/plugins/characterCombat/editor/useTacticalEditorPreviewSelection";
import { useTacticalEditorPreviewDragGuards } from "@/plugins/characterCombat/editor/useTacticalEditorPreviewDragGuards";
import { useTacticalEditorPreviewDragCompletion } from "@/plugins/characterCombat/editor/useTacticalEditorPreviewDragCompletion";
import TacticalEditorLegacyCircleHud from "@/plugins/characterCombat/editor/TacticalEditorLegacyCircleHud";
import TacticalEditorObjectPropertiesHud from "@/plugins/characterCombat/editor/TacticalEditorObjectPropertiesHud";
import TacticalEditorToolsHud from "@/plugins/characterCombat/editor/TacticalEditorToolsHud";
import TacticalEditorTracingTemplateHud from "@/plugins/characterCombat/editor/TacticalEditorTracingTemplateHud";
import {
  CIRCLE_TOOL_ID,
...
const TacticalScenarioEditorClient = ({ PlaytestComponent }: {
  ...
  return <main className="flex h-screen w-screen flex-col overflow-hidden bg-[#050a12] font-mono text-slate-100">
    ...
    >
      ...
      />
      <TacticalEditorScenarioMenu
        open={openHeaderMenu === "scenario"}
        draft={draft}
        canBeginPlaytest={canBeginPlaytest}
        dirty={dirty}
    ...
    <TacticalEditorOpenScenarioDialog
      open={openScenarioDialog}
      fileBusy={fileBusy}
      scenarioListBusy={scenarioListBusy}
      fileMessage={fileMessage}
    ...
    />
    <TacticalEditorScenarioPropertiesDialog
      ...
      onClose={closeFileDialog}
    />
    <TacticalEditorNewScenarioDialog
