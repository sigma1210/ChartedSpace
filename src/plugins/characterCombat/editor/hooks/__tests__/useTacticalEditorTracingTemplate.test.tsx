...
import { editorDraftChanged } from "@/plugins/characterCombat/editor/redux/tacticalEditorSlice";
import type { TracingTemplateTransformDrag } from "@/plugins/characterCombat/editor/lib/tacticalEditorInteractionState";
import { createAppStore, type AppStore } from "@/store";
import { uploadTacticalTemplate } from "../../lib/tacticalEditorApi";
import { loadImageDimensions } from "../../lib/tacticalEditorSupport";
...
jest.mock("../../lib/tacticalEditorSupport", () => ({
  ...jest.requireActual("../../lib/tacticalEditorSupport"),
