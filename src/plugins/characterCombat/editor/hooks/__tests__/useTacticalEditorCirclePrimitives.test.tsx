...
import type { CircleDraft, CirclePrimitiveDrag } from "../../lib/tacticalEditorInteractionState";
import { CIRCLE_AREA_TOOL_ID, CIRCLE_TOOL_ID } from "../../lib/tacticalEditorSupport";
