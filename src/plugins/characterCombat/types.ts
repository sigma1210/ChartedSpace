...
export interface CombatScenario {
  ...
  walls: WallSegment[]; doors: DoorSegment[]; objects: MapObject[]; combatants: Combatant[]; gravityMode?: "normal" | "zero-g"; handholds?: GridPoint[]; vacuumSources?: GridPoint[]; fireCells?: GridPoint[]; smokeCells?: GridPoint[]; victoryCondition?: "secure-objective" | "rescue-extract" | "hold-zone" | "staged-objectives"; captiveId?: string; holdUntilTurn?: number; stageObjectiveIds?: string[]; stageUnlockDoorId?: string;
}
